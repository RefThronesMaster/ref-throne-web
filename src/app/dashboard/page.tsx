      ...
      [
        {
          ...
          value: (row: TActVal) => (
            <span>
              {dayjs(new Date(Number(row.timestamp))).format(
                "YYYY.MM.DD HH:mm:ss Z"
              )}
            </span>
          ),
        },
        {
          ...
          width: 140,
          value: (row: TActVal) => LabelActType[row.act_type - 1],
        },
        {
          field: "tor_changes",
        ...
        },
        {
          ...
          value: (row: TActVal) => (
            <span>
              {`${Intl.NumberFormat("en-US").format(Number(row.tor_balance))}`}
            </span>
          ),
        },
        {
        ...
        },
        {
          ...
          value: (row: TActVal, index: number) => (
            <span>
              {index == 0 ? (
                <LiveAccumPoint data={row} />
              ) : (
                `${Intl.NumberFormat("en-US").format(Number(row.total_points))}`
              )}
            </span>
          ),
        },
